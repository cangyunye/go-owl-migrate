...
| 连接串示例 | 直连 OBServer(2881):`oceanbase-oracle://sys@tenant:pass@host:2881/db`（无需集群）；OBProxy(2883) 多集群:用户名 `sys@tenant#cluster`；TNS:`oracle://user:pass@host:2883/service_name` |
