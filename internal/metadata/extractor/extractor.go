...
func GetQuerySQL(dbType, objectType string) string {
	...
	if base == "oracle" {
		...
		case "indexes":
			return queryOracleIndexes
		case "fk", "foreign_keys":
			return queryOracleForeignKeys
		case "views":
			return queryOracleViews
		case "sequences":
			return queryOracleSequences
		case "triggers":
			return queryOracleTriggers
		case "synonyms":
			return queryOracleSynonyms
		}
	}
	if base == "postgres" {
		switch ot {
		...
		case "columns":
			return queryPGColumns
		case "pk", "primary_keys":
			return queryPGPrimaryKeys
		case "indexes":
			return queryPGIndexes
		case "fk", "foreign_keys":
			return queryPGForeignKeys
		case "views":
			return queryPGViews
		case "sequences":
			return queryPGSequences
		case "triggers":
			return queryPGTriggers
		}
	}
	if base == "mysql" {
		switch ot {
		case "tables":
			return queryMySQLTables
		case "columns":
			return queryMySQLColumns
		case "pk", "primary_keys":
			return queryMySQLPrimaryKeys
		case "indexes":
			return queryMySQLIndexes
		case "fk", "foreign_keys":
			return queryMySQLForeignKeys
		case "views":
			return queryMySQLViews
		case "triggers":
